...
/** 是否是SDK*/
@property (nonatomic, assign, class) BOOL sdkFlag;
/** 设置调试日志*/
...
@property(nonatomic, assign, readonly) BOOL showPowerAlertFlag;
...
/**
 ...
 @param block 状态回调
 */
- (void)connectPeripheral:(CBPeripheral *)peripheral internalModel:(NSString *)internalModel mac:(NSString *)mac connectConfig:(QNConnectConfig *)config response:(nullable QNCentralResponseBlock)block;
...
/**
 ...
 @param block 状态回调
 */
- (void)cancelConnectDevicePeripheral:(CBPeripheral *)peripheral logCode:(nullable NSString *)logCode response:(nullable QNCentralResponseBlock)block;
