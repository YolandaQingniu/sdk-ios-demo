...
#pragma mark -
@implementation NSData (YLBase64)
...
#pragma mark -
@implementation NSData (YLCommonDigest)
- (NSData *)qnSHA256Hash{
...
@implementation NSData (YLLowLevelCommonCryptor)
...
#pragma mark -
@implementation NSData (YLCommonCryptor)
...
@implementation NSError (YLCommonCryptoErrorDomain)
